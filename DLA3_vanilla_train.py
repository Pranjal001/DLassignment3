# -*- coding: utf-8 -*-
"""DLA_A3_VANILLA_WANDBattentiontrain.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16aI7UuBuu5h8B6SEXlk5oABssw67a5s0
"""
...
class lang:
    ...
    #dictionary creates char to int and int to char for mapping values
        data.discard('<')
        data.discard('>')
        chartoint = {"": 0, '<':1, '>':2}
        inttochar = {}
...
#implementing attention module for attention based model
...
parser.add_argument('-es', '--embedding_size', type=int, default=512, help='Embedding size')
parser.add_argument('-hs', '--hidden_size', type=int, default=512, help='Hidden size')
parser.add_argument('-l', '--layers', type=int, default=4, help='layers size')
parser.add_argument('-mt', '--module_type', type=str, default='GRU', choices=['RNN', 'LSTM', 'GRU'], help='Module type (RNN, LSTM, GRU)')
parser.add_argument('-dt', '--dropout', type=float, default=0.5, help='Dropout rate')
...
parser.add_argument('-bw', '--beam_search_width', type=int, default=3, help='Beam search width')
